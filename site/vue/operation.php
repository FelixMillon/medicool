 ...
 <div style="display: flex; flex-direction: column; height: 87vh;"> 
    <h2 class="d-flex align-items-center text-light fw-bold text-start" style="padding-left : 10%;background: #86B9BB; height:7vh" >Gestion des opérations </h2>
            ...
            <div class="container" >
                    <div class="col p-4 d-flex flex-column position-static">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <input type="date" name="date" class="inscricase form-control text-center fw-bold" style="border:3px solid #86B9BB" value="" > 
                                </div>

                                <div class="col-12">
                                    <input type="number" name="duree" placeholder="Durée" class="inscricase form-control text-center fw-bold" style="border:3px solid #86B9BB" value="">
                                </div>
