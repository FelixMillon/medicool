 ...
 <div style="display: flex; flex-direction: column; height: 87vh;"> 
    <h2 class="d-flex align-items-center text-light fw-bold text-start" style="padding-left : 10%;background: #86B9BB; height:7vh" >Gestion des patients opérer </h2>
            ...
            <div class="container" >
                    <div class="col p-4 d-flex flex-column position-static">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <input type="text" name="raison" placeholder="Raison" class="inscricase form-control text-center fw-bold" style="border:3px solid #86B9BB" value="">
                                </div>
                                ...
                                <select class="form-select w-100 text-center" style="border-radius:15px;border:3px solid #86B9BB">
                                    <option selected>Validité des documents</option>
