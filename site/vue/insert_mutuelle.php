    ...
    <div class="container" >
        ...
        <div class="row g-3">  
            ...
            <div class="col-12">
                ...
                style="border:3px solid #86B9BB" value="<?php if ($LaMutuelle!=NULL) echo $LaMutuelle['libelle']; ?>">
            </div>
            ...
            <div class="col-6">
                ...
                style="border:3px solid #86B9BB" value="<?php if ($LaMutuelle!=NULL) echo $LaMutuelle['pourcent_rembourse']; ?>">
            </div>
            ...
            <div class="col-6" style="padding-top: 6%">          
                ...
                <?php if($LaMutuelle!=NULL) echo 'name ="Modifier" value ="Modifier" '; else echo 'name="Valider" value ="Valider"'; ?>> 
            </div>
        </div>       
    </div>
    </div>
