<div class="table-responsive w-100" style="height:40vh;border : 4px solid #86B9BB;  border-radius: 10px;">
    <table class="table table-striped table-sm" >
        ...
        echo "<tr class='text-center'>
            ...
            <td><center>".$uneAllergie['libelle']."</center></td>
            ...
            <td><center>".$uneAllergie['id_patient']."</center></td>
            
            <td> 
                <a href='index.php?page=20&action=sup&id_allergie=".$uneAllergie['id_allergie']."'><img src='img/sup.png' height='30' width='30'></a>                            
                <a href='index.php?page=20&action=edit&id_allergie=".$uneAllergie['id_allergie']."'><img src='img/edit.png' height='30' width='30'></a>
            </td>
        </tr>";
        } 
        ?>
