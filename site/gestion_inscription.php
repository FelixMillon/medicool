...
{
    if($unControleur->verifMotDePasse($_POST['mdp']))
    {
        ...
        echo'le mot de passe doit contenir au moins une majucule, une minuscule, un caractère spécial et faire 8 caractères de longueur.';
    }
}
